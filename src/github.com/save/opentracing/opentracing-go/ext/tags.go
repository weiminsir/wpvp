...
var (
	...
	// server-side to describe the other side/control in a peer-to-peer
	// communications, like an RPC call.
	//////////////////////////////////////////////////////////////////////

	// PeerService records the control name of the peer.
	PeerService = stringTagName("peer.control")
