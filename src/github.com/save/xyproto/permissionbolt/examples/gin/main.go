...
func main() {
	...
	g.GET("/register", func(c *gin.Context) {
		...
		c.String(http.StatusOK, fmt.Sprintf("UserId bob was created: %v\n", userstate.HasUser("bob")))
	})

	g.GET("/confirm", func(c *gin.Context) {
		userstate.MarkConfirmed("bob")
		c.String(http.StatusOK, fmt.Sprintf("UserId bob was confirmed: %v\n", userstate.IsConfirmed("bob")))
	})

	g.GET("/remove", func(c *gin.Context) {
		userstate.RemoveUser("bob")
		c.String(http.StatusOK, fmt.Sprintf("UserId bob was removed: %v\n", !userstate.HasUser("bob")))
	})
