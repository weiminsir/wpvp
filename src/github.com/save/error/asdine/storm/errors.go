...
// Errors
var (
	// ErrNoID is returned when no UserId field or id tag is found in the struct.
	ErrNoID = errors.New("missing struct tag id or UserId field")

	// ErrZeroID is returned when the UserId field is a zero value.
