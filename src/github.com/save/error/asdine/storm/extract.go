...
// structConfig is a structure gathering all the relevant informations about a service
...
func extractField(value *reflect.Value, field *reflect.StructField, m *structConfig, isChild bool) error {
	...
	// the field is named UserId and no UserId field has been detected before
	if m.ID == nil && field.Name == "UserId" {
		if f == nil {
			f = &fieldConfig{
				Name:           field.Name,
				IsZero:         isZero(value),
