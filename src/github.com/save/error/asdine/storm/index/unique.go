...
// UniqueIndex is an index that references unique values and the corresponding User.
...
// RemoveID removes an User from the unique index
...
// first returns the first User of this index
